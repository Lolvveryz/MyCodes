...
for obj in a:
    ...
    type_value = [obj["id"], obj["category"].lower()]

    name_value = obj['displayName'].lower()
    new[name_value] = type_value
import json
with open('./bot/minecraft/entities.json', 'w', encoding='utf-8') as file:
    json.dump(new, file)